...
const BloomrStyleCard = ({ subtitle, title, description, videoSrc, bgClass }) => {
  return (
    <div
      className={`bg-gradient-to-br ${bgClass} rounded-3xl sm:rounded-[40px] p-4 sm:p-6 md:p-4 lg:p-10 flex flex-col md:flex-row  items-center md:items-start gap-6 sm:gap-8 md:gap-25 w-3/4 h-full shadow-lg`}
    >
      {/* Left: Video */}
      <div className="w-full md:w-1/3 mt-6 sm:mt-8 md:mt-12 ml-0 sm:ml-3 mr-0 sm:mr-4">
        <video
